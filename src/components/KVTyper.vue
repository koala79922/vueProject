    ...
    <div class="page-table">
      <div class="table-cell text-center">
        <div class="container">
          ...
          <h2 class="typer-title">
            <vue-typer :text="['I am a Front-End Developer','Photography and Travel lover']"></vue-typer>
            <br/>
            <vue-typer :text="['圖片來源','https://www.pixiv.net/artworks/60895189']"></vue-typer>
          </h2>
...
import ImgPicBg from '../assets/images/head-bg.png'
  ...
  data () {
    return {
      ...
      worksLink: [
        {
          iconName: 'github',
          link: 'https://github.com/shueny'
        },
        {
          iconName: 'github-alt',
          link: 'https://shueny.github.io/'
        },
        {
          iconName: 'wordpress',
